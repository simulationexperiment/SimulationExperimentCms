...
const experimentReportEditRouter = require('./routes/experimentReportEdit');
...
const classScheduleOfTeacherEditRouter = require('./routes/classScheduleOfTeacherEdit');
...
app.use('/experimentReport/edit', experimentReportEditRouter);
...
app.use('/classScheduleOfTeacher/edit', classScheduleOfTeacherEditRouter);
